  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-4">
        <h3 className="text-xl md:text-2xl font-bold" style={{ color: primaryColor }}>{title}</h3>
        ...
        <Link
          to={`/accolades/${id}`}
          className="inline-flex items-center font-semibold rounded-lg px-4 py-2 transition-colors duration-300 hover:bg-orange-50"
